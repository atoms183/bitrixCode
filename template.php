   ...
   <div class="block_content_right" >	
	 ...
	 <div class="video_content" >
	   ...
	   <div class="video_top" >
		...
		<p>Магнитные гель-лаки всегда весьма эффектно выглядят на ногтях. Давайте вместе рассмотрим все этапы создания маникюра с использованием нескольких гель-лаков и акриловой краски. И результат - один из вариантов неповторимого дизайна ногтей.</p>
	...
	<?foreach($arResult["ITEMS"] as $arItem):?>
	                   ...
	                   <div class="video_bott_text" id="<?=$this->GetEditAreaId($arItem['ID']);?>">	
